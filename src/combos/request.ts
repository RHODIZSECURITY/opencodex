...
export function concreteComboRequestBody(
  ...
  // caller effort, including those sentinels; excluding `none` is what let Auto-mode safety
  // side queries leak an unsupported Muse `none` through a combo configured to force `high`.
